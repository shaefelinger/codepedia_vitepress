  ...
  '/vue/basics/': [
    {
      text: 'Vue',
      items: [
        { text: 'Basics', link: '/vue/basics/' },
        { text: 'VS-Code Settings', link: '/vue/basics/vue-vscode' },
        {
          text: 'Project Structure',
          link: '/vue/basics/vue-project-structure',
        },
        { text: 'Data-Binding', link: '/vue/basics/vue-data-binding' },
        {
          text: 'Conditional Rendering',
          link: '/vue/basics/vue-conditional-rendering',
        },
        { text: 'List Rendering', link: '/vue/basics/vue-list-rendering' },
        { text: 'Events', link: '/vue/basics/vue-events' },
        { text: 'Dynamic Styling', link: '/vue/basics/vue-dynamic-styling' },
        {
          text: 'Advanced Reactivity',
          link: '/vue/basics/vue-advanced-reactivity',
        },
        { text: 'Template Refs', link: '/vue/basics/vue-template-refs' },
        { text: 'Lifecycle Hooks', link: '/vue/basics/vue-lifecycle-hooks' },
        { text: 'Components', link: '/vue/basics/vue-components' },
        { text: 'Passing Data', link: '/vue/basics/vue-passing-data' },
        { text: 'Slots', link: '/vue/basics/vue-slots' },
        {
          text: 'Dynamic Components',
          link: '/vue/basics/vue-dynamic-components',
        },
        { text: 'Forms', link: '/vue/basics/vue-forms' },
        { text: 'Teleporting', link: '/vue/basics/vue-teleporting' },
        { text: 'Axios', link: '/vue/basics/vue-axios' },
        { text: 'Options API', link: '/vue/basics/vue-options-api' },
        { text: 'Composition API', link: '/vue/basics/vue-composition-api' },
        { text: 'Script Setup', link: '/vue/basics/vue-script-setup' },
        { text: 'Composables/Hooks', link: '/vue/basics/vue-composables' },
        { text: 'Mixins', link: '/vue/basics/vue-mixins' },
        { text: 'Styleguide', link: '/vue/basics/vue-styleguide' },
        { text: 'Error-Handling', link: '/vue/basics/vue-error-handling' },
        { text: 'Links', link: '/vue/basics/vue-links' },
      ],
    },
  ],
  '/vue/router/': [
    {
      text: 'Vue-Router',
      items: [
        { text: 'Vue-Router Basics', link: '/vue/router/' },
        { text: 'Styling active Links', link: '/vue/router/styling-links' },
        { text: 'Registering Routes', link: '/vue/router/registering-routes' },
        { text: 'Build-In Components', link: '/vue/router/vue-router-components' },
        { text: 'Changing Routes', link: '/vue/router/changing-routes' },
        { text: 'Programmatic Navigation', link: '/vue/router/programmatic-nav' },
        { text: 'Passing data with Route Parameter', link: '/vue/router/passing-data' },
        { text: 'History Mode', link: '/vue/router/history-mode' },
        { text: 'Handling 404s', link: '/vue/router/handling404s' },
        { text: 'Router extras', link: '/vue/router/extras' },
        { text: 'Navigation guards', link: '/vue/router/navigation-guards' },
      ],
    },
  ],
  '/vue/state/': [
